...
urlpatterns = [
    ...
    path('photo/add-photosession', add_photosession, name='add-photosessions'),
    url('avatar/', include('avatar.urls')),
    path('password-reset/', views.PasswordResetView.as_view(template_name="password_reset_form.html"),
         name='password_reset'),
